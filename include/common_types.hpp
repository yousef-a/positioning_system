...
enum class msg_type {TESTMSG, SERIALDATA ,reference, THREEAXISSENSORMSG, VELOCITY, ACCELERATION, THERMALIMAGE, optitrack, FLIGHTSCENARIO, POSITION, ATTITUDE, HEADING, NOZZLEMSG,control_system, user, controller, float_msg, BOOLEAN, switcher, VECTOR3D, external_reference, ack,internal_msg_start,internal_ros };
...
enum class control_system_msg_type {switch_in_out, add_block, change_PID_settings, to_system, provider_data, SETREFERENCE};
