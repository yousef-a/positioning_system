...
enum class msg_type {TESTMSG, SERIALDATA ,reference, THREEAXISSENSORMSG, optitrack, POSITION, ATTITUDE, HEADING,control_system, user, controller, float_msg, switcher, vector3D_msg, external_reference, ack,internal_msg_start,internal_ros };
...
enum class block_frequency {hz100, hz1000};
