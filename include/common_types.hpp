...
enum class msg_type {set_reference, optitrack, position, attitude, control_system, user, controller, float_msg, switcher, vector3D_msg, external_reference, ack,internal_msg_start,internal_ros };
